...
//#define USER "usera"
extern const char *USER; // EAP User Credentials. Defined in INO file. Needed in eap-psk.cpp
extern const uint8_t PSK[16];  // EAP User Credentials. Defined in INO file. Needed in eap-psk.cpp
